...
class Stats {
  ...
  private score_text:      HTMLElement;
  private last_score_text: HTMLElement;
  private best_score_text: HTMLElement;
  ...
  constructor(root:HTMLElement) {
    ...
    this.best_score = Storage.get("best_score")??0
    this.last_score = Storage.get("last_score")??0
